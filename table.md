...
| No | Nama Backlog                                      | Task                                                            | Pengerjaan (Hari) |
|----|---------------------------------------------------|-----------------------------------------------------------------|-------------------|
| 1  | Pengaturan Jenis Surat Keterangan - Administrator | Membuat antarmuka daftar data jenis surat keterangan            | 0.25              |
|    |                                                   | Membuat antarmuka tambah data jenis surat keterangan            | 0.25              |
|    |                                                   | Membuat antarmuka ubah data jenis surat keterangan              | 0.25              |
|    |                                                   | Membuat fungsi menampilkan daftar data Jenis Surat Ketearnga    | 0.25              |
|    |                                                   | Membuat fungsi tambah data jenis surat keterangan               | 0.25              |
|    |                                                   | Membuat fungsi ubah data jenis surat keterangan                 | 0.25              |
|    |                                                   | Membuat fungsi hapus data jenis surat keterangan                | 0.5               |
| 2  | Manajemen Pengguna - Administrator                | Membuat antarmuka daftar data Pengguna                          | 0.25              |
|    |                                                   | Membuat antarmuka tambah data Pengguna                          | 0.25              |
|    |                                                   | Membuat antarmuka ubah data Pengguna                            | 0.25              |
|    |                                                   | Membuat fungsi menampilkan daftar data Pengguna                 | 0.25              |
|    |                                                   | Membuat fungsi tambah data Pengguna                             | 0.25              |
|    |                                                   | Membuat fungsi ubah data Pengguna                               | 0.25              |
|    |                                                   | Membuat fungsi hapus data Pengguna                              | 0.5               |
| 3  | Ganti Password                                    | Membuat antarmuka Ganti Password                                | 0.25              |
|    |                                                   | Membuat fungsi menampilkan Ganti Password                       | 0.25              |
|    |                                                   | Membuat fungsi simpan Ganti Password                            | 0.5               |
| 4  | Halaman Utama - Rukun Tetangga                    | Membuat antarmuka halaman utama - rukun tetangga                | 0.5               |
|    |                                                   | Membuat fungsi menampilkan halaman utama - rukun tetangga       | 0.5               |
| 5  | Halaman Utama - Rukun Warga                       | Membuat antarmuka halaman utama - rukun warga                   | 0.5               |
|    |                                                   | Membuat fungsi menampilkan halaman utama - rukun warga          | 0.5               |
| 6  | Halaman Utama - Pihak Desa                        | Membuat antarmuka halaman utama - pihak desa                    | 0.5               |
|    |                                                   | Membuat fungsi menampilkan halaman utama - pihak desa           | 0.5               |
| 7  | Halaman Pengajuan Surat - Penduduk                | Membuat antarmuka pengajuan surat                               | 0.5               |
|    |                                                   | Membuat fungsi menampilkan pengajuan surat                      | 0.5               |
| 8  | Halaman Formulir Pengajuan Surat - Penduduk       | Membuat antarmuka formulir pengajuan surat keterangan           | 1                 |
|    |                                                   | Membuat antarmuka formulir pengajuan surat keterangan kelahiran | 1                 |
|    |                                                   | Membuat antarmuka formulir pengajuan surat keterangan domisili  | 1                 |
...
| No | Nama Backlog                              | Task                                                       | Pengerjaan (Hari) |
|----|-------------------------------------------|------------------------------------------------------------|-------------------|
| 1  | Simpan Pengajuan Surat - Penduduk         | Membuat fungsi simpan pengajuan surat keterangan kelahiran | 1                 |
|    |                                           | Membuat fungsi simpan pengajuan surat keterangan domisili  | 1                 |
|    |                                           | Membuat fungsi simpan pengajuan surat keterangan pindah    | 1                 |
|    |                                           | Membuat fungsi simpan pengajuan surat keterangan nikah     | 1                 |
| 2  | Halaman Pelacakan Surat - Penduduk        | Membuat antarmuka pelacakan surat                          | 1                 |
|    |                                           | Membuat fungsi menampilkan pelacakan surat                 | 1                 |
| 3  | Halaman Pelacakan Suart Detail - Penduduk | Membuat antarmuka detail pelacakan surat                   | 1                 |
|    |                                           | Membuat fungsi menampilkan detail pelacakan surat          | 1                 |
| 4  | Pembatalan Surat - Penduduk               | Membuat antarmuka pembatalan surat                         | 1                 |
|    |                                           | Membuat fungsi menyimpan pembatalan surat                  | 1                 |
| 5  | Cetak surat ke PDF - Penduduk             | Membuat antarmuka surat di pdf                             | 1                 |
|    |                                           | Membuat fungsi menampilkan surat di pdf                    | 1                 |
...
| No | Nama Backlog                             | Task                                                 | Pengerjaan (Hari) |
|----|------------------------------------------|------------------------------------------------------|-------------------|
| 1  | Setujui Pengajuan Surat - Rukun Tetangga | Membuat fungsi menyimpan Setujui Pengajuan Surat     | 1                 |
| 2  | Tolak Pengajuan Surat - Rukun Tetangga   | Membuat antarmuka Tolak Pengajuan Surat              | 1                 |
|    |                                          | Membuat fungsi menyimpan Tolak Pengajuan Surat       | 1                 |
| 3  | Halaman Proses Surat - Rukun Warga       | Membuat antarmuka Halaman Proses Surat               | 1                 |
|    |                                          | Membuat fungsi menyimpan Halaman Proses Surat        | 1                 |
| 4  | Setujui Pengajuan Surat - Rukun Warga    | Membuat antarmuka Setujui Pengajuan Surat            | 1                 |
|    |                                          | Membuat fungsi menyimpan Setujui Pengajuan Surat     | 1                 |
| 5  | Tolak Pengajuan Surat - Rukun Warga      | Membuat antarmuka Tolak Pengajuan Surat              | 1                 |
|    |                                          | Membuat fungsi menyimpan Tolak Pengajuan Surat       | 1                 |
| 6  | Halaman Proses Surat - Pihak Desa        | Membuat antarmuka Halaman Proses Surat               | 1                 |
|    |                                          | Membuat fungsi menyimpan Halaman Proses Surat        | 1                 |
| 7  | Kirim Surat Ke Pegawai Lain - Pihak Desa | Membuat antarmuka Kirim Surat Ke Pegawai Lain        | 1                 |
...
| No | Nama Backlog                            | Task                                                | Pengerjaan (Hari) |
|----|-----------------------------------------|-----------------------------------------------------|-------------------|
| 1  | Set Selesai - Pihak Desa                | Membuat antarmuka Set Selesai                       | 1                 |
